...
1. **На первом устройстве:**
   ...
   - Выберите "☁️ Включить синхронизацию"
   - Введите название списка
   - Выберите "☁️ Получить данные для синхронизации" - учетные данные будут скопированы в буфер обмена

2. **На втором устройстве:**
   - Откройте меню Tampermonkey → AVE Script
   - Выберите "☁️ Подключить синхронизацию"
