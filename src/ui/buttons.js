import { addUserToBlacklist, removeUserFromBlacklist, addOfferToBlacklist, removeOfferFromBlacklist } from '../core/blacklist.js';
...
export function insertButtonContainer(offerElement) {
...
export function insertBlockSellerButton(offerElement, offerInfo, onComplete) {
...
export function insertBlockOfferButton(offerElement, offerInfo, onComplete) {
  let buttonContainer = offerElement.querySelector('.button-container');
  if (!buttonContainer) {
    buttonContainer = insertButtonContainer(offerElement);
  }
...
export function insertUnblockSellerButton(offerElement, offerInfo, onComplete) {
  let buttonContainer = offerElement.querySelector('.button-container');
  if (!buttonContainer) {
    buttonContainer = insertButtonContainer(offerElement);
  }
...
export function insertUnblockOfferButton(offerElement, offerInfo, onComplete) {
  let buttonContainer = offerElement.querySelector('.button-container');
  if (!buttonContainer) {
    buttonContainer = insertButtonContainer(offerElement);
  }
